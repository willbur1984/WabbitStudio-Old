...
// adc a,reg8
// adc a,(hl)
static void add_a_reg(CPU_t *cpu, int carry) {
	int result;
	int reg;
	tc_add(cpu->timer_c,4);
	switch ((cpu->bus)&7) {
...
// add a,num8
// adc a,num8
static void add_a_num(CPU_t *cpu, int carry) {
	int result;
	int reg;
	tc_add(cpu->timer_c,7);
...
// sbc a,reg8
// sbc a,(hl)
static void sub_a_reg(CPU_t *cpu, int carry) {
	int result;
	int reg;
	tc_add(cpu->timer_c, 4);
	switch ((cpu->bus)&7) {
...
// sub num8
// sbc a,num8
static void sub_a_num(CPU_t *cpu,int carry) {
	int result;
	int reg;
	tc_add(cpu->timer_c,7);
	reg = CPU_mem_read(cpu,cpu->pc++);
