...
/* 81 */
static int calc_init_81(LPCALC lpCalc, char *version) {
	/* INTIALIZE 81 */
...
static void check_bootfree_and_update(LPCALC lpCalc) {
...
static int calc_run_tstates(LPCALC lpCalc, time_t tstates) {
