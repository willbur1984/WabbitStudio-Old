...
static void gif_clear_tree(int cc, GIF_TREE *root) {
	int i;
	GIF_TREE *newNode, **xx;
...
static unsigned char *gif_code_to_buffer(int code, short n, unsigned char *buf) {
	int mask;
...
static int gif_encode(FILE *fout, BYTE *pixels, int depth, int siz) {
