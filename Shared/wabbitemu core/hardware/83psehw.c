...
static void port5_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port15_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port8_83pse(CPU_t *cpu, device_t *dev) {
...
static void port9_83pse(CPU_t *cpu, device_t *dev) {
	LINKASSIST_t* assist = (LINKASSIST_t *) dev->aux;
...
static void port0A_83pse(CPU_t *cpu, device_t *dev) {
	LINKASSIST_t *assist = (LINKASSIST_t *) dev->aux;
	if (cpu->input) {
		cpu->bus = assist->in;
		assist->read = FALSE;
...
static void port0D_83pse(CPU_t *cpu, device_t *dev) {
	LINKASSIST_t *assist = (LINKASSIST_t *) dev->aux;
	if (cpu->input) {
		cpu->bus = assist->out;
		assist->ready = FALSE;
...
static void port0E_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
		cpu->input = FALSE;
		cpu->bus = *((int *)dev->aux);
	} else if (cpu->output) {
...
static void port0F_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
		cpu->input = FALSE;
		cpu->bus = *((int *)dev->aux);
	} else if (cpu->output) {
...
static unsigned long calc_md5(MD5_t* md5) {
...
static void md5ports(CPU_t *cpu, device_t *dev) {
...
static void port20_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port21_83pse(CPU_t *cpu, device_t *dev) {
...
static void port22_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port23_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port24_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
		cpu->input = FALSE;
...
static void port25_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void port26_83pse(CPU_t *cpu, device_t *dev) {
	if (cpu->input) {
...
static void delay_ports(CPU_t *cpu, device_t *dev) {
...
static void mod_timer(CPU_t *cpu, XTAL_t* xtal) {
	int a, b, c;
...
static void port_chunk_remap_83pse(CPU_t *cpu, device_t *dev) {
...
static void port30_83pse(CPU_t *cpu, device_t *dev) {
...
static void port31_83pse(CPU_t *cpu, device_t *dev) {
	XTAL_t* xtal = (XTAL_t *) dev->aux;
	TIMER_t* timer = &xtal->timers[(DEV_INDEX(dev) - 0x30) / 3];
	if (cpu->input) {
...
static void port32_83pse(CPU_t *cpu, device_t *dev) {
	XTAL_t* xtal = (XTAL_t *) dev->aux;
	TIMER_t* timer = &xtal->timers[(DEV_INDEX(dev)-0x30)/3];
...
static void clock_enable(CPU_t *cpu, device_t *dev) {
...
static void clock_set(CPU_t *cpu, device_t *dev) {
	CLOCK_t* clock = (CLOCK_t *) dev->aux;
	if (cpu->input) {
...
static void clock_read(CPU_t *cpu, device_t *dev) {
	CLOCK_t* clock = (CLOCK_t *) dev->aux;
	if (cpu->input) {
		unsigned long time;
...
static void GenerateUSBEvent(CPU_t *cpu, USB_t *usb, int bit, BOOL lowToHigh) {
	if (lowToHigh) {
...
static void port4A_83pse(CPU_t *cpu, device_t *dev) {
...
static void port4C_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port4D_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port54_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port55_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux; 
	if (cpu->input) {
...
static void port56_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port57_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port5B_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
		cpu->bus = 0x00;
...
static void port80_83pse(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
...
static void port_83pse(CPU_t *cpu, device_t *dev) {
	//USB_t *usb = (USB_t *) dev->aux;
	if (cpu->input) {
		cpu->input = FALSE;
	} else if (cpu->output) {
...
static void fake_usb(CPU_t *cpu, device_t *dev) {
	USB_t *usb = (USB_t *) dev->aux; 
	if (cpu->input) {
		switch(DEV_INDEX(dev)) {
...
static link_t* link83pse_init(CPU_t* cpu) {
...
static SE_AUX_t* SE_AUX_init(CPU_t* cpu) {
