...
static int link_init(CPU_t *cpu) {
...
static BOOL check_flashpage_empty(u_char (*dest)[PAGE_SIZE], u_int page, u_int num_pages) {
 ...
 */
static void fix_certificate(CPU_t *cpu, u_int page) {
...
static int get_page_size(u_char (*dest)[PAGE_SIZE], int page) {
	int i;
