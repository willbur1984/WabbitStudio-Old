...
static void setpage83(CPU_t *cpu) {
...
static void port00_82(CPU_t *cpu, device_t *dev) {
...
static void port00_83(CPU_t *cpu, device_t *dev) {
	link_t* link = (link_t *) dev->aux;
	STDINT_t* stdint = (STDINT_t *) cpu->pio.devices[0x02].aux;
...
static void port02_83(CPU_t *cpu, device_t *dev) {
...
static void port03_83(CPU_t *cpu, device_t *dev) {
...
static void port04_83(CPU_t *cpu, device_t *dev) {
...
static link_t* link83_init(CPU_t* cpu) {
